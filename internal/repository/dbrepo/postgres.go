...
//update Reservation 
func (m *postgreDBRepo) UpdateReservation(u models.Reservation) ( error){
...
//update processed Reservation 
func (m *postgreDBRepo) UpdateProcessedForReservation(processed, id int) ( error){
